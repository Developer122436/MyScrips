...
ws = wb.active
# Datatype casting(more memory) - Pandas will always try to guess which value of casting will be - it is integer or string? Because we already specified all columns as string, pandas will not need to guess and the excel will word faster.
df = pd.read_csv(
    "crime.csv",
    encoding="utf-8",
    dtype={
